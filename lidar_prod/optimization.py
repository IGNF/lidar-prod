...
@commons.eval_time
def optimize_building(config: DictConfig):  # pragma: no cover  (it's just an initialyzer of a class/method tested elsewhere)
    """
...
def optimize_vegetation(config: DictConfig):  # pragma: no cover  (it's just an initialyzer of a class/method tested elsewhere)
...
def optimize_unclassified(config: DictConfig):  # pragma: no cover  (it's just an initialyzer of a class/method tested elsewhere)
