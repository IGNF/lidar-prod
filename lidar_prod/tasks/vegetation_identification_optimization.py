...
class VegetationIdentificationOptimizer:
    def __init__(
        self,
        paths: Dict[str, str],
        vegetation_identifier: VegetationIdentifier,
        ...
        self.paths = paths
        self.vegetation_identifier = vegetation_identifier
    ...
    def optimize(self):
        ...
        best_thresholds = self.select_best_thresholds(self.study)
        ...
        self.vegetation_identifier.vegetation_thresholds = best_thresholds
    ...
    def _optuna_objective_func(self, trial):
        ...
        self.vegetation_identifier.vegetation_thresholds = trial.suggest_float("min_vegetation_proba", 0.0, 1.0)
    ...
    def select_best_thresholds(self, study):
        """Gets the trial that maximizes IoU."""
        return Max(study.best_trials, key=lambda x: x.values[0], reverse=True)
